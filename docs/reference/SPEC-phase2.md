> **Note:** Read-only reference copy from `travispollard.com` at commit `ab38b7b1abcf23707ab282ab7474569a7dd7c2e0`. The original file in `travispollard.com/cfb/docs/` governs.
