---
name: sagarin-format
description: Parsing rules and known traps for Jeff Sagarin's college football ratings page at sagarin.com. Use when writing, debugging, or reviewing any code that fetches, parses, validates, or stores Sagarin ratings, or when reconciling Sagarin team names against another source.
---
...
1. Teams sorted by rating
2. Conference averages
3. Teams grouped by conference
